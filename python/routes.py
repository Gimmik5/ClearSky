"""
Flask Routes Module - V1.1 PULL Mode Complete Edition

All endpoints including gallery, file manager, and SD browser
"""
...
def register_routes(app):
        ...
        try:
            ...
            for filename in sorted(os.listdir(IMAGE_DIR), reverse=True):
                if filename.endswith(('.jpg', '.jpeg', '.JPG', '.JPEG')):
                    ...
                    # Extract timestamp from filename (sky_YYYYMMDD_HHMMSS.jpg)
    ...
    def test_endpoint():
        ...
        return jsonify({
            "status": "ok",
            "message": "Server is running (V1.1 Pull Mode)",
    ...
    def get_image_by_timestamp(timestamp):
        ...
        try:
            ...
            print(f"Error in /image/<timestamp>: {e}")
            return str(e), 500
